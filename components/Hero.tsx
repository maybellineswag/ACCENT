        ...
        <div className="flex gap-4 pt-32 sm:pt-12 lg:pt-24 pb-8 items-start justify-start flex-col">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mt-3 overflow-visible">
            <GradientButton asChild className="relative z-50 shadow-lg hover:shadow-xl px-4 sm:px-9 w-full sm:w-auto">
              <a href="https://t.me/maybellineswag" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between sm:justify-start gap-2 sm:gap-4 w-full sm:w-auto">
                <span className={cn(
                  ...
                  {language === 'en' ? "Start your project" : (language === 'cs' ? "Začněte svůj projekt" : (language === 'ru' ? "Начать projekt" : "Start your project"))}
                </span>
            ...
            >
              ...
              <span>{translations?.common?.bookCall || (language === 'en' ? "Book a call" : (language === 'cs' ? "Rezervovat hovor" : "Book a call"))}</span>
            </a>
          </div>
        </div>
      </div>
